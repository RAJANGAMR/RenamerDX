...
async def start(bot, update):
          ...
          reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton(text='⭕ Channel ⭕', url=f'https://t.me/{Config.UPDATE_CHANNEL}'),
                                                 InlineKeyboardButton(text='⭕ Group ⭕', url=f'https://t.me/{Config.UPDATE_GROUP}') ],
                                               [ InlineKeyboardButton(text='👮 Developer', url='https://t.me/Tamil_Support'),
                                                 InlineKeyboardButton(text='🚸 Powered By', url='https://t.me/Tamil_Support') ],
                                               [ InlineKeyboardButton(text='🔐 Cancel 🔐', callback_data='DM') ] ] ) )
